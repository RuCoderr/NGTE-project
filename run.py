...
async def lk(message: Message):
    ...
    await message.answer(f'Личный кабинет\n\n🆔 Ваш ID: <code>{user_id}</code>\n━━━━━━━━━━━━━━━━━━━━━━━━━\n💼 Ваш '
                         ...
                         f'баланс: <b>{int(bal[0])} руб</b>\n📶 Трудоустройство: <b>{str(status[0])}</b>', parse_mode='HTML')
...
async def info(message: Message):
    ...
    await message.answer('ℹ️ Информация о компании - на сайте: ссылка \n\nРуководство по пользованию ботом: \n\n💵 '
    ...
    'появится в сети, он ответит на ваше сообщение \n\n❗ Чтобы вывести деньги с баланса бота, нужно завершить процесс трудоустройства.  Все вопросы по поводу трудоустройства уточняйте у куратора')
